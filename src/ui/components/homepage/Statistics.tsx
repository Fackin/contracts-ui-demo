...
export function Statistics(): React.ReactElement | null {
  ...
  return (
    <>
      <div
        className="mb-5 mt-10 grid w-full grid-cols-4 gap-4 border border-b border-gray-200 p-6 rounded-xl bg-white dark:bg-transparent dark:border-gray-800 xl:grid-cols-2"
        data-cy="chain-info"
      >
